...
\begin{itemize}
	...
	\item We elaborate about the usefulness of optimizations for our own index structure Elf~\cite{}.
\end{itemize}
% Paper structure
...
\footnotesize
	...
	\begin{center}
		\begin{tabular}{l|c|c|c|c|c}
			\hline
			\multirow{2}{*}{\textbf{Criterium}}&\textbf{Seg-Tree/}&\multirow{2}{*}{\textbf{FAST}}&\multirow{2}{*}{\textbf{ART}}&\multirow{2}{*}{\textbf{VAST}}&\multirow{2}{*}{\textbf{Impact}}\\
			&\textbf{Trie}&&&&\\
			\hline
			Horizontal vectorization & x & x & x & x & high\\[.1cm]
			Minimized key size & o & - & x & x & high\\[.1cm]
			Adapted node sizes and types & - & x & - & x & low\\[.1cm]
			Decreased branch misses & - & x & - & x & medium\\[.1cm]
			Full use of cache line using& \multirow{2}{*}{-} &  \multirow{2}{*}{x} &  \multirow{2}{*}{-} &  \multirow{2}{*}{x} &  \multirow{2}{*}{medium}\\
			 blocking and alignment &&&&&\\[.1cm]
			Usage of Compression & o & - & x & x & medium\\[.1cm]
			Adapt search algorithm  for&  \multirow{2}{*}{x}  &  \multirow{2}{*}{-} &  \multirow{2}{*}{-}  &  \multirow{2}{*}{-}  &  \multirow{2}{*}{low} \\
			 linearized nodes &&&&&\\
			 \multicolumn{6}{c}{}\\
			\hline
			\multicolumn{6}{|c|}{Legend: x = implements the issue; o = partially implements the issue;}\\
			\multicolumn{6}{|c|}{ - = does not implement the issue}\\
			\hline
		\end{tabular}
		\label{tasuaib2011architecture}
	\end{center}
