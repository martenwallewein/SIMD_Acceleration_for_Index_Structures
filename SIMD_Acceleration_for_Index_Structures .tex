...
$\rightarrow$ Decrease branch and cache misses\\
$\rightarrow$ Fully use cache/SIMD lines, aligning blocks?\\
$\rightarrow$ Compare more keys, Save space with compression?\\
$\rightarrow$ Use SIMD for tree traverse, k-ary search?\\
$\rightarrow$ Adapted search algorithm compared to linear search?\\
