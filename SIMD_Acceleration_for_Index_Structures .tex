...
\section{Evaluation}
% What we want to do:
In this section, we compare the adaptions made in Seg-Tree, FAST, ART, and VAST to increase performance and show differences. We focus on the usage of SIMD within the adapted index structures. 
