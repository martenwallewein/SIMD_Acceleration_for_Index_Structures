...
\subsection{Simple instruction multiple data}\label{SCM}
...
on Modern CPUs and GPUs'' in SIGMOD’10, June 6-11, 2010, Indianapolis, Indiana, USA. TODO: Author count more than 6
\end{thebibliography}
