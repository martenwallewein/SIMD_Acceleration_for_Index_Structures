...
% Segmenting the tree
Secondly, all index structures are adapted to better use SIMD and cache lines. Zeuch et al. linearise keys to a multiple of the SIMD bandwith with the Seg-Tree, Changkyu et al. segmented FAST into SIMD, cache, and page blocks. 
