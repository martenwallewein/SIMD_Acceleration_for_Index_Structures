...
\bibitem{b2} J. Zhou and K. A. Ross  ``Implementing Database Operations Using SIMD Instructions'' in ACM SIGMOD, pp. 145-156, 2002.%, Madison, Wisconsin, USA
...
\bibitem{b4} V. Leis, A. Kemper and T. Neumann ``The Adaptive Radix Tree: ARTful Indexing for Main-Memory Databases'' in ICDE, pages 38-49, 2013.
\bibitem{b5} T. Yamamuro, M. Onizuka, T. Hitaka, and M. Yamamuro ``VAST-Tree: A Vector-Advanced and Compressed Structure for Massive Data Tree Traversal'' in EDBT, pp. 396-407, 2012.%, Berlin, Germany.
\bibitem{b6} C. Kim, J. Chhugani, N. Satish, E. Sedlar, A. D. Nguyen, T. Kaldewey, V. W. Lee, S. A. Brandt and P. Dubey ``FAST: Fast Architecture Sensitive Tree Search on Modern CPUs and GPUs'' in SIGMOD, pp. 339-350, 2010.%, Indianapolis, Indiana, USA.
\bibitem{b7}O. Polychroniou, A. Raghavan and K. A. Ross, ``Rethinking SIMD Vectorization for In-Memory Databases'' in SIGMOD, pages 1493-1508, 2015.%, Melbourne, Victoria, Australia.
...
\bibitem{b13} J. Rao and K. A. Ross ``Making $B^+$-Trees cache conscious in main memory'' in SIGMOD, Vol. 29, No.2, pp. 475-486, 2000.
