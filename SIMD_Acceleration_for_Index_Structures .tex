...
\begin{table*}[htbp]
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|}
			...
			Minimize key size & o & - & x & x\\
			Adapt node sizes and types & - & x & - & x\\
...
\subsection{Adapt node sizes and types}
% Reason for the performance issue
...
Leis et al. present different node types for ART. 
%- Seg-Tree/Trie: K-ary search tree as inner nodes\\
%- ART: Different node types\\
%- FAST: Blocks, but not sure if adapted node types\\
%- VAST: same as FAST\\
...
\subsection{Save space and cache line bandwidth using compression}
