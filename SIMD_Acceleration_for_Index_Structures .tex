...
The authors of FAST adapted a binary tree to optimize for architecture features like page size, cache line size, and SIMD bandwith. The authors show the performance increase because of decreasing cache misses and better cache line usage.  
